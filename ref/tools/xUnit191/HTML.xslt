...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <html>
            <head>
                <title>
                    xUnit.net Test Results - <xsl:value-of select="//assembly/@name"/>
                </title>
                <style type="text/css">
                    ...
                    .divided { border-top: solid 2px #f0f5fa; padding-top: 0.5em; margin-top: 0.5em }
            ...
            <body>
                <h2 class="divided"><b>Assemblies Run</b></h2>
                <xsl:apply-templates select="//assembly"/>
				<h2 class="divided"><b>Environment</b></h2>
                <div>
                    <i>Test Run Timestamp:</i><span>&#160;</span><xsl:value-of select="//assembly/@run-date"/><span>&#160;</span><xsl:value-of select="//assembly/@run-time"/><br/>
                    <i>Test Framework:</i><span>&#160;</span><xsl:value-of select="//assembly/@test-framework"/><br/>
                    <i>CLR Environment:</i><span>&#160;</span><xsl:value-of select="//assembly/@environment"/><br/>
                </div>
                <h2 class="divided"><b>Summary</b></h2>
                <div>
                ...
                <xsl:if test="//assembly/class/test[@result='Fail']">
                    <br />
                    <h2 class="divided"><a name="failures"></a>Failed tests</h2>
