//--------------------------------------------------------------------------
// File:    BinaryFormatterWrapper.cs
// Content:	Implementation of class BinaryFormatterWrapper
...
{
	/// <summary>
	/// Wraps the <see cref="BinaryFormatter"/> in the <see cref="ISerializationFormatter"/>
	/// interface so it can be used in a standardized manner.
	/// </summary>
	internal class BinaryFormatterWrapper : ISerializationFormatter
	{
