...
// ReSharper restore CheckNamespace
{
	...
	/// The method itself should be marked by <see cref="JetBrains.Annotations.AssertionMethodAttribute" /> attribute.
	/// The mandatory argument of the attribute is the assertion type.
	/// </summary>
	/// <seealso cref="JetBrains.Annotations.AssertionConditionType" />
	...
	/// To set the condition, mark one of the parameters with <see cref="JetBrains.Annotations.AssertionConditionAttribute" /> attribute
	/// </summary>
	...
	public sealed class ContractAnnotationAttribute : Attribute
	{
		...
		/// </summary>
		/// <param name="fdt">The FDT.</param>
		/// <param name="forceFullStates">if set to <see langword="true"/> [force full states].</param>
		...
		/// </summary>
		/// <value>
		///   <see langword="true"/> if [force full states]; otherwise, <see langword="false"/>.
		/// </value>
	...
	/// However, using '==' or '!=' for comparison with <see langword="null"/> is always permitted.
	/// </summary>
	/// <example>
	/// <code>
